...
log.Info($"Started summitlifedailyreport9.WebApiLand.WebApiLand Program");
...
builder.Services.AddDbContextPool<DsSummitLifeContext>(options => options.UseSqlServer(
    withEfConnection,
